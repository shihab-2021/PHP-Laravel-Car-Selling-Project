...
<html lang="en">
  ...
  <body>
    ...
    <div class="" style="height: 100% !important;">
        <div class="container d-flex align-items-center justify-content-center" style="height: 100% !important;">
            <div class="center mx-auto rounded-4" style="padding: 40px; background: #004eff0d;">
                ...
                <form action="{{route('login-user')}}" method="post">
                    ...
                    <div class="form-group pt-3">
                        <button class="btn fw-bold btn-block btn-outline-info w-100 rounded-pill" type="submit">Login</button>
                    </div>
                    <br>
                    <div class="text-center fw-bold"><a href="registration">New user! Click here for register.</a></div>
                </form>
            </div>
        </div>
    </div>
